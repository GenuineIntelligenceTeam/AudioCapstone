...
sampleData: List of tuples (f1,f2, delta time)
...
def FingerprintMatcher(database, sampleData):
    ...
    for index, item in enumerate(sampleData): #Loops through the sample audio and seperates the index and item (f1, f2, delta time)
